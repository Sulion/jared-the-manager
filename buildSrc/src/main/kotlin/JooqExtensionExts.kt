...
fun Database.props(action: MutableList<Property>.() -> Unit) {
    this.withProperties(*arrayListOf<Property>().also(action).toTypedArray())
}

fun MutableList<Property>.prop(action: Property.() -> Unit) {
    this.add(Property().apply(action))
}
